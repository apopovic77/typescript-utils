...
// --- Quaternion helpers (minimal, for rotation composition) ---
...
function quatFromMatrix(right: Vec3, up: Vec3, forward: Vec3): Quat {
...
export class Orientation {
     ...
     */
    static calculateOrientationEuler(
        tangent: Vec3,
        normal: Vec3,
        binormal: Vec3,
        _position: Vec3,
        ...
        let finalRight: Vec3, finalUp: Vec3, finalForward: Vec3;
